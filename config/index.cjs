  ...
  USERS: [
    {
      ...
      id: 'oCLxI63r4pGY0SeJNsBTbLWqqQhg',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '	mmdvRVZc4CgE1WZ7UdfsGj7iPKxL1lg_JV-kr3QM_H0',
      // 所在省份
      province: '河北',
      // 所在城市
      city: '邯郸',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '周周', year: '1998', date: '06-27',
        }
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '庆庆', year: '2004', date: '08-21',
        }
      ],
